...
if os.path.exists("data/bug_bytes.db"):
    os.remove("data/bug_bytes.db")

db = spidb.Database(r"data/bug_bytes.db")

os.chdir(r"data")

#%%
events = pd.read_csv(r"bug_bytes/Insect-Pest-Sounds-inventory_1.csv")
#%%
# aspids = spidb.Sensor(
#     name = "ASPIDS",
