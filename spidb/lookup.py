table = {
    ...
    "mealworm": r"Tenebrio molitor larva",
    ...
    "maggot": r"Musca domestica (larva)",
    ...
    "tenebrio molitor (larva)": r"Mealworm",
    "tenebrio molitor larva": r"Mealworm",
    "tenebrio molitor": r"Darkling beetle",
    "musca domestica (larva)": r"Maggot",
...
table_latex = {
    ...
    "mealworm": r"$\it{Tenebrio}$ $\it{molitor}$ larva",
    ...
    "maggot": r"$\it{Musca}$ $\it{domestica}$ (larva)",
    ...
    "tenebrio molitor (larva)": r"$\it{Tenebrio}$ $\it{molitor}$ larva",
    "tenebrio molitor larva": r"$\it{Tenebrio}$ $\it{molitor}$ larva",
    "tenebrio molitor": r"$\it{Tenebrio}$ $\it{molitor}$",
    "musca domestica (larva)": r"$\it{Musca}$ $\it{domestica}$ larva",
...
table_latex_min = {
    ...
    "mealworm": r"$\it{T.}$ $\it{molitor}$ larva",
    ...
    "maggot": r"$\it{M.}$ $\it{domestica}$ (larva)",
    ...
    "tenebrio molitor (larva)": r"$\it{T.}$ $\it{molitor}$ larva",
    "tenebrio molitor larva": r"$\it{T.}$ $\it{molitor}$ larva",
    "tenebrio molitor": r"$\it{T.}$ $\it{molitor}$",
    "musca domestica (larva)": r"$\it{M.}$ $\it{domestica}$ larva",
    "musca domestica larva": r"$\it{M.}$ $\it{domestica}$ larva",
